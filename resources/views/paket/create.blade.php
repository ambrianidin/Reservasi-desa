...
@section('content')
<div class="card mb-4">
    <h6 class="card-header">Create Paket Wisata</h6>
    <div class="card-body">
        @if ($errors->any())
        ...
        <form action="{{ route('paketWisata.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="nama_paket" id="nama_paket" class="form-control" value="{{ old('nama_paket', session('form_data.nama_paket')) }}" required>

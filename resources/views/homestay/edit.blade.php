        ...
        <form action="{{ route('homestay.update', $homestays->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="file" name="foto1" id="foto1" accept="image/*" value="{{ $homestays->foto1 ?? '' }}" required>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group col-md-6">
                    <label for="foto2" class="form-label">Pict 2</label>
                    <input class="form-control" type="file" name="foto2" id="foto2" accept="image/*" value="{{ $homestays->foto2 ?? '' }}" required>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="file" name="foto3" id="foto3" accept="image/*" value="{{ $homestays->foto3 ?? '' }}">
                    <div class="clearfix"></div>
                </div>
                <div class="form-group col-md-6">
                    <label for="foto4" class="form-label">Pict 4</label>
                    <input class="form-control" type="file" name="foto4" id="foto4" accept="image/*" value="{{ $homestays->foto4 ?? '' }}" >
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control" type="file" name="foto5" id="foto5" accept="image/*" value="{{ $homestays->foto5 ?? '' }}"  >
                    <div class="clearfix"></div>
                </div>
            </div>

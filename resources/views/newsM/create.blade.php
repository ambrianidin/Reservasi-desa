...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('newsM.store') }}" method="POST" enctype="multipart/form-data" id="newsForm">
            @csrf
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="date" name="tgl_post" id="tgl_post" class="form-control" value="{{ old('tgl_post') }}" required>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="form-group">
                <label class="form-label">News Content</label>
                <textarea name="berita" id="berita" class="form-control" rows="5" style="resize: vertical; word-wrap: break-word;" required>{{ old('berita') }}</textarea>
                <div class="clearfix"></div>
            </div>
            <div class="form-row">

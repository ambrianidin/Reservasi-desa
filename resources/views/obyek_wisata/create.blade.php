...
<div class="card mb-4">
    ...
    <div class="card-body">
        ...
        @endif
        <form action="{{ route('obyek-wisata.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label class="form-label">Name Wisata</label>
                    <input type="text" name="nama_wisata" id="nama_wisata" class="form-control" value="{{ old('nama_wisata', session('form_data.nama_wisata')) }}" required>
                    <div class="clearfix"></div>
                </div>
                <div class="form-group col-md-6">
                    <label class="form-label">Description Wisata</label>
                    <input type="text" name="deskripsi_wisata" id="deskripsi_wisata" class="form-control" value="{{ old('deskripsi_wisata', session('form_data.deskripsi_wisata')) }}" required>
                    <div class="clearfix"></div>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-secondary">Create Obyek Wisata</button>
